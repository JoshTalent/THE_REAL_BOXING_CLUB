...
import { Calendar, User, Clock, ArrowRight, Search, TrendingUp, Heart, Dumbbell, Utensils, Users, BookOpen, Filter } from "lucide-react";
          ...
          <div className="relative h-full flex items-center justify-center p-12">
            ...
            >
              <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-3xl p-8 shadow-2xl">
                ...
                <h2 className="text-2xl font-bold mb-4">{popularPosts[0]?.title}</h2>
                <p className="text-blue-100 mb-6 leading-relaxed">{popularPosts[0]?.excerpt}</p>
                <div className="flex items-center justify-between text-sm text-blue-200">
                  <div className="flex items-center gap-4">
                    <div className="flex items-center gap-1">
                      <Calendar className="w-4 h-4" />
                      <span>{new Date(popularPosts[0]?.date).toLocaleDateString()}</span>
                    </div>
                    <div className="flex items-center gap-1">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            >
              ...
              {/* Popular Posts */}
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
                <h3 className="text-lg font-bold text-gray-900 mb-4">Popular Reads</h3>
                <div className="space-y-4">
                  {popularPosts.map((post) => (
                    <div key={post.id} className="flex items-center gap-3 p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors cursor-pointer">
                      <img
                        src={post.image}
                        alt={post.title}
